              ...
              <div class="table-responsive">
	            ...
	            .card {
                  ...
                  <tbody>
                    <?php
                    $id = $_GET["id"];
                    $sql = "SELECT * FROM Usuario WHERE idUsuario='$id' LIMIT 10"; 
                    $result = mysqli_query($conexion,$sql);  

                    while($mostrar = mysqli_fetch_array($result)){
                    ?>
					<!--formulario de editar "actualizarusua.php -->
				    <form action="procesar_editarUsu.php" method="post">
						<input type="hidden" value="<?php echo $mostrar['idUsuario'] ?>" name="txtidUsuario">
						<p>Nombre</p>
						...
						<p>Celular</p>
						<input type="txtPassword" value="<?php echo $mostrar['Password'] ?>" name="txtPassword">
						<p>Tipo</p>
						<input type="text" value="<?php echo $mostrar['Tipo_Usua'] ?>" name="txtTipo_Usua">
						<p>Email</p>
